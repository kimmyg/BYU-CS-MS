...
(define (substitute-app e1 e2)
  (let ((k (gensym 'k))
        ...
        (e (gensym 'e))
        (f (gensym 'f)))
    `(λ (,k) (λ (,m) ((λ (,k) (,k (λ (z) ((z (λ (x) (λ (y) y))) ((λ (p) (p (λ (x) (λ (y) y)))) ,m)))))
                      (λ (,n) ((,e1
                                (λ (,e) ((,e2
                                          (λ (,f) (((,e ,f) ,k) ,m)))
                                         ,n)))
       ...
       `(λ (,k) (λ (,m) ((λ (,k) (,k (,m (λ (x) (λ (y) y)))))
                         (λ (,s) ((λ (,k) (,k (((((,s (λ (x) x)) (λ (z) z)) (λ (x) (λ (k) (λ (m) (k (λ (y) (λ (k) (λ (m) (k y))))))))) (λ (,v) (λ (,k) (λ (,m) (,k ,v))))) (λ (z) z))))
                                  (λ (,t) ((λ (,k) (,k (,m (λ (x) (λ (y) x)))))
                                           (λ (,f) ((λ (,k) (,k ((,f ,t) ,s)))
                                                    (λ (,a) ((λ (,k) (,k (λ (p) ((p (λ (x) (λ (y) y))) ,s))))
                                                             (λ (,u) ((,(transform e1)
                                                                       (λ (,v) ((λ (,k) (,k (λ (p) ((p (λ (x) (λ (y) x))) (λ (,k) (λ (,m) (,k (λ (z) ,(substitute-app (transform `(z ,v)) a)))))))))
                                                                                (λ (,m) ((,(transform e2)
                                                                                          (λ (,v) ((((λ (,v) (λ (,k) (λ (,m) (,k ,v)))) ,v) ,k) ,m)))
                                                                                         ,m)))))
                                                                      ,u)))))))))))))]
      [(list 'λ (list x1) e1)
