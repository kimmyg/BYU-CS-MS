...
K= &\bullet e,E;k        & \chi(k)\\
   & v\,\bullet;k        & \chi(k)\\
   & \mathrm{wcm}\,\bullet\,e,E;k & \chi(k)\\
   & \mathrm{wcm}\,v; k           & v:\chi(k)\\
   & \mathrm{halt}       & \mathrm{empty}
\end{align*}
\caption{Machine grammar (?)}
\label{machine-grammar}
\end{figure}
...
\langle v,E,\mathrm{wcm}\,\bullet e',E';k\rangle        &\rightarrow\langle e',E',\mathrm{wcm}\,v;k\rangle\\
...
Figures \ref{machine-grammar} and \ref{machine-semantics} present the grammar and machine 
semantics for continuation marks. Figure \ref{machine-grammar} also includes the definition 
of the $\chi$ metafunction in this context.
