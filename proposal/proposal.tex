...
$(v\,\circ)$ denoting the same in which the argument value is under evaluation, $(\mathrm{wcm}\,
...
\langle v,E,\mathrm{wcm}\,\circ e',E';k\rangle           &\rightarrow\langle e',E',\mathrm{wcm}\,v;f(k)\rangle\\
...
It is typical to use the programming language Haskell \cite{jones2003haskell} to reason 
about and algebraically manipulate semantic defintions. Haskell is a purely functional programming
