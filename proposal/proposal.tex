...
% later we can talk about continuation marks and continuations, simulating dynamic scope, recursion and tail recursion detection.
...
%... what does it actually mean? if we can show it satisfies the mono requirement, is it a computational model?
