...
\abstract{Continuation marks have not yet been transformed into the pure $\lambda$-calculus. A CPS-like transformation of continuation marks would aide in their correct compilation. We propose a transformation from the $\lambda$-calculus augmented with continuations marks to the pure $\lambda$-calculus and verification that this transformation preserves language meaning.}
