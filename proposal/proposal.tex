...
\newcommand{\Title}{A Continuation-Passing Style Transformation for Continuation Marks}
...
Continuation-passing style is a characterization of code in which an additional formal 
...
the \emph{continuation} with their results as the argument. In, computation represented in 
CPS, all control- and data-flow is explicit.

Continuation-passing style (CPS) is a characterization of code in which no function ever 
returns. Instead, each 
...
intermediate representation [cite essence]. Take a simple computation such as
