...
that values in the language are $\lambda$-abstractions.
...
We will present a transformation in the spirit of CPS from $\lambda_{cm}$ to the $\lambda$-calculus. Furthermore, we will provide and prove a meaning-preservation theorem.
