...
p\rightarrow_{\lambda_{cm}}v &\Rightarrow\bullet[p]\rightarrow_{\lambda_{cm}}v &\text{(since $p=\bullet[p]$)}\\
                             &\Rightarrow((\mathcal{C}[p]\,\mathcal{C}[\bullet])\,((\mathbf{pair}\,\xi(\bullet))\,\mathcal{C}[\chi(\bullet)]))\rightarrow_{\lambda_v} \mathcal{C}[v] &\text{(by the Great Lemma)}\\
                             &\Rightarrow((\mathcal{C}[p]\,(\lambda\,(v)\,\mathcal{C}[v]))\,((\mathbf{pair}\,\mathbf{false})\,\mathcal{C}[\mathbf{nil}]))\rightarrow_{\lambda_v} \mathcal{C}[v] &\text{(by definitions x, y, and z)}\\
