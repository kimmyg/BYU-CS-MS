...
\begin{proof}[Case $E=\mathrm{wcm}\,[] e$, $[]=wcm\,E'\,F'$]
evaluate v (pretend it's not a value)
attach to marks according to outer context

\end{proof}

\begin{proof}[Case $E=\mathrm{wcm}\,v []$, $e=wcm\,E'\,F'$]
evaluate v (pretend it's not a value)
...
provide an interpreter or new semantics for lambda_cm that has the list of continuation 
