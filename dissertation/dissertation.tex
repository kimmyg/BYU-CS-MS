...
% assume C[e2] goes to correct value (structural induction) E[e2] -> E[v2]
...
\begin{align*}
\bullet[e]\rightarrow v\\
((\mathcal{C}[e]\,\mathcal{C}[\bullet])\,\overline{((\mathbf{pair}\,\xi(\bullet))\,\mathcal{C}[\chi(\bullet)])})\\
\end{align*}
\end{proof}
