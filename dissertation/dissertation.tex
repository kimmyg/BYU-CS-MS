...
$\mathcal{A}$ has the property that $\mathcal{A}[\app{\C{e_0}}{\C{e_1}}]=\C{\app{e_0}{e_1}}$.
\begin{schemedisplay}
(lambda (k)
  (lambda (m)
    ((lambda (k) (k ((PAIR FALSE) (SND m))))
...
Fix $E$ and assume it works for $E$. (That is, assume that $E[v]\cmrrs v'\implies\C{E[v]}\lvrrs v'$.)
...
$\C{E'[\wcm{v_0}{\hole}][v_1]}=\C{E'[v_1]}$, by definition.

If $E\ne E'[\wcm{v'}{\hole}]$ for any $E'$ and $v'$, $\C{E[\wcm{v_0}{e_1}]}\lvrrs\C{E[\wcm{v_0}{\hole}][e_1]}$, by wcm13-no-tail-wcm18-no-tail.
...
Fix $e$ and assume it works for $e$. (That is, assume that $E[e]\cmrrs E[v]\implies\C{E[e]}\lvrrs\C{E[v]}$.)

\begin{proof}{Case $E=\hole$}
$\hole[e]\cmrrs\hole[v]\implies\C{\hole[e]}\lvrrs\C{\hole[v]}$, by assumption.

$\C{\hole[v]}\lvrr\C{v}$, by [a lemma].
\end{proof}

\begin{proof}{Case $E=E'[\app{\hole}{e_1}]$}
$E[\app{\hole}{e_1}][e_0]\cmrrs E[\app{\hole}{e_1}][v_0]\implies\C{E[\app{\hole}{e_1}][e_0]}\lvrrs\C{E[\app{\hole}{e_1}][v_0]}$, by assumption.
...
wcm17-tail
\begin{schemedisplay}
((lambda (m) ((Ce_1 CE) m)) ((PAIR TRUE) C[((PAIR v_0) (SND chiE))]))
\end{schemedisplay}

wcm18-tail
\begin{schemedisplay}
((Ce_1 CE) ((PAIR TRUE) C[((PAIR v_0) (SND chiE))]))
\end{schemedisplay}
...
wcm17-not-tail
\begin{schemedisplay}
((lambda (m) ((Ce_1 CE) m)) ((PAIR TRUE) C[((PAIR v_0) chiE)]))
\end{schemedisplay}

wcm17-not-tail
\begin{schemedisplay}
((Ce_1 CE) ((PAIR TRUE) C[((PAIR v_0) chiE)]))
\end{schemedisplay}
