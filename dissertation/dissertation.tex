...
v     &\text{if $\app{\app{p}{\C{\hole}}}{\eval{\pair{\xi(\hole)}{\C{\chi(\hole)}}}}\lvrrs v$}\\
\perp &\text{if $\app{\app{p}{\C{\hole}}}{\eval{\pair{\xi(\hole)}{\C{\chi(\hole)}}}}\lvrrs\cdots$}
\end{cases}
\]
\end{defn}
...
\begin{proof}
\begin{align*}
\app{\Cp{\abs{x}{e_0}}}{\Cp{\abs{y}{e_1}}} = &\app{\abs{x}{\C{e_0}}}{\abs{y}{\C{e_1}}}\\
                                       \lvrr &\C{e_0}[x\leftarrow \abs{y}{\C{e_1}}]\\
                                           = &\C{e_0[x\leftarrow \abs{y}{e_1}}]
\end{align*}
(It's obvious.)
\end{proof}
