...
\mathcal{C}_{1}[\app{E}{F}]                 &= \lambda k.\lambda m.((\mathcal{C}_{1}[E]\,\lambda e.((\mathcal{C}_{1}[F]\,\lambda f.(((e\,f)\,k)\,m))\,m))\,m)\\
\mathcal{C}_{1}[\wcm{E}{F}]   &= \lambda k.\lambda m.((\mathcal{C}_{1}[E]\,\lambda e.((\mathcal{C}_{1}[F]\,k)\,\mathbf{(}e\mathbf{,}m\mathbf{)}))\,m)\\
...
\setspecialsymbol{Cv}{$\mathcal{C}[v]$}
\setspecialsymbol{v_0}{$v_0$}
\setspecialsymbol{Cv_0}{$\mathcal{C}[v_0]$}
\setspecialsymbol{Cv_0p}{$\mathcal{C}[v'_0]$}
\setspecialsymbol{Cpv_0}{$\mathcal{C}'[v_0]$}
\setspecialsymbol{Cpv_1}{$\mathcal{C}'[v_1]$}
...
\setspecialsymbol{Ce_0p_x_Cpv_1}{$\mathcal{C}[e'_0][x\leftarrow\mathcal{C}'[v_1]]$}
\setspecialsymbol{e_0p_x_v_1}{$e'_0[x\leftarrow v_1]$}
\setspecialsymbol{Cz}{$\mathcal{C}[z]$}
\setspecialsymbol{CE}{$\mathcal{C}[E]$}
...
v     &\text{if $((p\,(\lambda\,(v)\,\mathcal{C}[v]))\,((\mathbf{pair}\,\mathbf{false})\,\mathcal{C}[\mathbf{nil}]))\lvrrs v$}\\
\perp &\text{if $((p\,(\lambda\,(v)\,\mathcal{C}[v]))\,((\mathbf{pair}\,\mathbf{false})\,\mathcal{C}[\mathbf{nil}]))\lvrrs \cdots$}
\end{cases}
\]
...
For all values $(\lambda\,(x)\,e)$, $(\mathcal{C}[\hole]\,\mathcal{C}'[(\lambda\,(x)\,e)]=\mathcal{C}[(\lambda\,(x)\,e)]$.
\end{lemma}

\begin{proof}
\begin{align*}
(\mathcal{C}[\hole]\,\mathcal{C}'[(\lambda\,(x)\,e)] = &((\lambda\,(v)\,\mathcal{C}[v])\,\mathcal{C}'[(\lambda\,(x)\,e)]\\
                                                       = &((\lambda\,(v)\,\mathcal{C}[v])\,(\lambda\,(x)\,\mathcal{C}[e])\\
                                 \lvrr &\mathcal{C}[v][v\leftarrow (\lambda\,(x)\,\mathcal{C}[e])]\\
...
\begin{eqtheorem}
For all contexts $E\in\lambda_{cm}$ and expressions $e\in\lambda_{cm}$, $E[e]\cmrrs v\implies ((\mathcal{C}[e]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})\lvrrs \mathcal{C}[v]$.
\end{eqtheorem}

Fix $E$ and assume it works for $E$.

\begin{proof}[Case $e=(e_0\,e_1)$]
% prove E[(e0 e1)] -> v => ((C[(e0 e1)] C[E]) ((pair xi(E)) C[chi(E)])) -> C[v]
Assume $E[(e_0\,e_1)]\cmrrs v$. Consider $((\mathcal{C}[(e_0\,e_1)]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})$.
% -> ((C[e0] C[E[(* e1)]]) ((pair xi(E[(* e1)])) C[chi(E[(* e1)])]))
Steps app1-app7 show
\[
((\mathcal{C}[(e_0\,e_1)]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})\lvrrs ((\mathcal{C}[e_0]\,\mathcal{C}[E[(\hole\,e_1)]])\,\overline{((\mathbf{pair}\,\xi(E[(\hole\,e_1)]))\,\chi(E[(\hole\,e_1)]))})
\]
...
\end{enumerate}
% assume C[e0] goes to correct value (structural induction) E[(* e1)][e0] -> E[(* e1)][v0]
Otherwise, we assume by induction that 
\[
((\mathcal{C}[e_0]\,\mathcal{C}[E[(\hole\,e_1)]])\,\overline{((\mathbf{pair}\,\xi(E[(\hole\,e_1)]))\,\chi(E[(\hole\,e_1)]))})\lvrrs (\mathcal{C}[E[(\hole\,e_1)]]\,\mathcal{C}'[v_0])
\]
where $E[(\hole\,e_1)][e_0]\cmrrs E[(\hole\,e_1)][v_0]$, as in app8.
% -> ((C[e1] C[E[(v0 *)]]) ((pair xi(E[(v0 *)])) C[chi(E[(v0 *)])]))
By app9, 
\[
(\mathcal{C}[E[(\hole\,e_1)]]\,\mathcal{C}'[v_0])\lvrr((\mathcal{C}[e_1]\,\mathcal{C}[E[(v_0\,\hole)]])\,\overline{((\mathbf{pair}\,\xi(E[(v_0\,\hole)]))\,\chi(E[(v_0\,\hole)]))})
\]
...
\end{enumerate}
% assume C[e1] goes to correct value (structural induction) E[(v0 *)][e1] -> E[(v0 *)][v1]
Otherwise, we assume by induction that 
\[
((\mathcal{C}[e_1]\,\mathcal{C}[E[(v_0\,\hole)]])\,\overline{((\mathbf{pair}\,\xi(E[(v_0\,\hole)]))\,\chi(E[(v_0\,\hole)]))})\lvrrs (\mathcal{C}[E[(v_0\,\hole)]]\,\mathcal{C}'[v_1])
\]
where $E[(v_0\,\hole)][e_1]\cmrrs E[(v_0\,\hole)][v_1]$, as in app10.
% -> ((C[(v0 v1)] C[E]) ((pair xi(E)) C[chi(E)]))
By app11,
\[
(\mathcal{C}[E[(v_0\,\hole)]]\,\mathcal{C}'[v_1])\lvrr(((\mathcal{C}'[v_0]\,\mathcal{C}'[v_1])\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})
\]
If $\mathcal{C}'[v_0]=(\lambda\,(x)\,\mathcal{C}[e'_0])$, then, by lemma \ref{collapse},
\begin{align*}
(((\mathcal{C}'[v_0]\,\mathcal{C}'[v_1])\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})\lvrr &((\mathcal{C}[e'_0[x\leftarrow v_1]]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})\\
% assume (v0 v1) -> e2
% -> ((C[e2] C[E]) ((pair xi(E)) C[chi(E)]))
= &((\mathcal{C}[e_2]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})
\end{align*}
for some $e_2$.

% ((C[v2] C[E]) ((pair xi(E)) C[chi(E)])) is correct by assumption (structural induction (and E?))
By induction, we assume that $E[e_2]\cmrrs v\implies((\mathcal{C}[e_2]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})\lvrrs \mathcal{C}[v]$.
...
% prove E[(wcm e0 e1)] -> v => ((C[(wcm e0 e1)] C[E]) ((pair xi(E)) C[chi(E)])) -> C[v]
Assume $E[\wcm{e_0}{e_1}]\cmrrs v$. Consider $((\mathcal{C}[\wcm{e_0}{e_1}]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})$.
% -> ((C[e0] C[E[(wcm * e1)]]) ((pair xi(E[(wcm * e1)])) C[chi(E[(wcm * e1)])]))
Steps wcm1-wcm7 show
\[
((\mathcal{C}[\wcm{e_0}{e_1}]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})\lvrrs ((\mathcal{C}[e_0]\,\mathcal{C}[E[\wcm{\hole}{e_1}]])\,\overline{((\mathbf{pair}\,\xi(E[\wcm{\hole}{e_1}]))\,\chi(E[\wcm{\hole}{e_1}]))})
\]
From here, we must account for two contingencies:
\begin{enumerate}
...
\end{enumerate}
% assume C[e0] goes to correct value (structural induction) E[(wcm * e1)][e0] -> E[(wcm * e1)][v0]
Otherwise, we assume by induction that 
\[
((\mathcal{C}[e_0]\,\mathcal{C}[E[\wcm{\hole}{e_1}]])\,\overline{((\mathbf{pair}\,\xi(E[\wcm{\hole}{e_1}]))\,\chi(E[\wcm{\hole}{e_1}]))})\lvrrs(\mathcal{C}[E[\wcm{\hole}{e_1}]]\,\mathcal{C}'[v_0])
\]
where $E[\wcm{\hole}{e_1}][e_0]\cmrrs E[\wcm{\hole}{e_1}][v_0]$, as in wcm8.
By wcm9-wcm13,
\[
(\mathcal{C}[E[(\wcm{\hole}{e_1}]]\,\mathcal{C}'[v_0])\lvrrs x
\]
...
%Then $E[\wcm{v_0}{e_1}]=E'[\wcm{v'}{\wcm{v_0}{e_1}}]$. Then %$\chi(E[\wcm{v_0}{\hole}])=\chiE'[\wcm{v'}{\wcm{v_0}{\hole}}]$
...
\begin{align*}
\chi(E[\wcm{v_0}{\hole}]) &=\overline{((\mathbf{pair}\,v_0)\,\chi(E))}\\
\end{align*}
\end{proof}

$E[\wcm{v_0}{v_1}]\cmrr E[v_1]$

$((\mathcal{C}[e_1]\,\mathcal{C}[E[\wcm{v_0}{\hole}]])\,\overline{((\mathbf{pair}\,\xi(E))\,\mathcal{C}[\chi(E)])})\lvrrs ((\mathcal{C}[v_1]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\mathcal{C}[\chi(E)])})$

$((\mathcal{C}[\wcm{v_0}{v_1}]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\mathcal{C}[\chi(E)])})\lvrrs ((\mathcal{C}[v_1]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\mathcal{C}[\chi(E)])})$


% assume reduces correctly by induction
% -> ((C[e1] C[E[(wcm v0 *)]]) ((pair xi(E[(wcm v0 *)])) C[chi(E[(wcm v0 *)])]))
% assume reduces by structural induction
\end{proof}

\begin{proof}[Case $e=\ccm$]
% prove E[(ccm)] -> v => ((C[(ccm)] C[E]) ((pair xi(E)) C[chi(E)])) -> C[v]
Assume $E[\ccm]\cmrrs v$. Consider $((\mathcal{C}[\ccm]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})$.
% -> ((C[e0] C[E[(* e1)]]) ((pair xi(E[(* e1)])) C[chi(E[(* e1)])]))
Steps ccm1-ccm3 show
\[
((\mathcal{C}[\ccm]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})\lvrrs ((\mathcal{C}[\chi(E)]\,\mathcal{C}[E])\,(\lambda\,(z)\,z))
\]
Since $\chi(E)$ is a value, we appeal to the value case.
\end{proof}

\begin{proof}[Case $e=v$]
% prove E[v] -> v' => ((C[v] C[E]) ((pair xi(E)) C[chi(E)])) -> C[v']
Assume $E[v]\cmrrs v'$. Consider $((\mathcal{C}[v]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})$.
% by assumption of E
By assumption of the correctness of $E$, $((\mathcal{C}[v]\,\mathcal{C}[E])\,\overline{((\mathbf{pair}\,\xi(E))\,\chi(E))})\lvrr\mathcal{C}[v']$.
\end{proof}

\begin{proof}[Case $e=x$]
% prove E[x] -> error => ((C[x] C[E]) ((pair xi(E)) C[chi(E)])) -> C[error]
% ?
\end{proof}
...
Assume $\hole[e]\cmrrs v$. Consider $((\mathcal{C}[e]\,C[\hole])\,\overline{((\mathbf{pair}\,\xi(\hole))\,\chi(\hole))})$.

By assumption on $e$, $((\mathcal{C}[e]\,C[\hole])\,\overline{((\mathbf{pair}\,\xi(\hole))\,\chi(\hole))})\lvrrs (\mathcal{C}[\hole]\,\mathcal{C}'[v])$.
By Lemma \ref{hole-context-to-value}, $(\mathcal{C}[\hole]\,\mathcal{C}'[v])\lvrr\mathcal{C}[v]$.
Then $\hole[e]\cmrrs v\implies((\mathcal{C}[e]\,\mathcal{C}[\hole])\,\overline{((\mathbf{pair}\,\xi(\hole))\,\chi(\hole))})\lvrrs \mathcal{C}[v]$.
\end{proof}

\begin{proof}{Case $E=E'[(\hole\,e_1)]$}
Assume $E'[(\hole\,e_1)][e]\cmrrs v$. Consider $((\mathcal{C}[e]\,C[E'[(\hole\,e_1)]])\,\overline{((\mathbf{pair}\,\xi(E'[(\hole\,e_1)]))\,\chi(E'[(\hole\,e_1)]))})$.

By assumption on $e$, $((\mathcal{C}[e]\,C[E'[(\hole\,e_1)]])\,\overline{((\mathbf{pair}\,\xi(E'[(\hole\,e_1)]))\,\chi(E'[(\hole\,e_1)]))})\lvrrs (\mathcal{C}[E'[(\hole\,e_1)]]\,\mathcal{C}'[v])$. $(\mathcal{C}[E'[(\hole\,e_1)]]\,\mathcal{C}'[v])\lvrr(C[e_1()$We assume, by induction, 
\end{proof}

\begin{proof}{Case $E=E'[\wcm{\hole}{e_1}]$}
Assume $E'[\wcm{\hole}{e_1}][e]\cmrrs v$.
Consider $((\mathcal{C}[e]\,\mathcal{C}[E'[\wcm{\hole}{e_1}]])\,\overline{((\mathbf{pair}\,\xi(E'[\wcm{\hole}{e_1}]))\,\mathcal{C}[\chi(E'[\wcm{\hole}{e_1}])])})$.
By assumption, $E'[\wcm{\hole}{e_1}][e]\cmrrs E'[\wcm{\hole}{e_1}][v']\implies((\mathcal{C}[e]\,\mathcal{C}[E'[\wcm{\hole}{e_1}]])\,\overline{((\mathbf{pair}\,\xi(E'[\wcm{\hole}{e_1}]))\,\mathcal{C}[\chi(E'[\wcm{\hole}{e_1}])])})\lvrr(\mathcal{C}[E'[\wcm{\hole}{e_1}]]\,\mathcal{C}'[v'])$, as in wcm8.
...
p\cmrrs v &\implies\mathrm{eval}_{cm}(p)=v &\text{(by definition of $\mathrm{eval}_{cm}$)}\\
                             &\implies\mathcal{C}[\mathrm{eval}_{cm}(p)]=\mathcal{C}[v] &\text{(by well-definedness of $\mathcal{C}$)}
\end{align*}

% does E[e] -> E[v] => ((C[e] C[E]) ((pair xi(E)) C[chi(E)])) -> C[E[v]] make sense?
% it doesn't look like it. consider what C[E[v]] is.
% does e -> v => C[e] -> C[v] make sense?
% not really, unless e is at the top level (so e is p).
% does E[e] -> v => ((C[e] C[E]) ((pair xi(E)) C[chi(E)])) -> C[v] make sense?
% assume it works for all E, prove e by induction
% assume it works for all e, prove E by induction

\begin{align*}
p\cmrrs v &\implies\hole[p]\cmrrs\hole[v] &\text{(since $p\cmrr \hole[p]$ and $v$ can only be reached by $\hole[v]$)}\\
                             &\implies((\mathcal{C}[p]\,\mathcal{C}[\hole])\,\overline{((\mathbf{pair}\,\xi(\hole))\,\mathcal{C}[\chi(\hole)])})\lvrrs\mathcal{C}[v] &\text{(by the Great Lemma)}\\
                             &\implies((\mathcal{C}[p]\,(\lambda\,(v)\,\mathcal{C}[v]))\,\overline{((\mathbf{pair}\,\mathbf{false})\,\mathcal{C}[\mathbf{nil}])})\lvrrs\mathcal{C}[v] &\text{(by definitions x, y, and z)}\\
                             &\implies\mathrm{eval}_{v}(\mathcal{C}[p])=\mathcal{C}[v] &\text{(by definition of $\mathrm{eval}_v$)}
\end{align*}
