...
\]
and $E[e']\cmrrs E[v']\implies\C{E[e']}\lvrrs\C{E[v']}$ follows by induction.
\end{proof}
...
Similar to the previous case, divergence is lifted to the entire program. Consider the case where $E[\wcm{\hole}{e_1}][e_0]\cmrrs E[\wcm{\hole}{e_1}][v_0]$.
...
\begin{proof}{Case $E=E'[\wcm{v'}{\hole}]$ for some $E'$ and $v'$}
...
$\C{E'[\wcm{v'}{\hole}][v]}=\C{E'[v]}$, by definition \ref{c-wcm-v-hole}. 
\end{proof}
