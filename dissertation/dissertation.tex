...
Assume $E[(e_0\,e_1)]\cmrrs v$. Consider $((\C[(e_0\,e_1)]\,\C[E])\,pair{\xi(E)}{\chi(E)})$.
% -> ((C[e0] C[E[(* e1)]]) ((pair xi(E[(* e1)])) C[chi(E[(* e1)])]))
Steps app1-app7 show
\[
((\C[(e_0\,e_1)]\,\C[E])\,pair{\xi(E)}{\chi(E)})\lvrrs ((\C[e_0]\,\C[E[(\hole\,e_1)]])\,pair{\xi(E[(\hole\,e_1)])}{\chi(E[(\hole\,e_1)])})
\]
