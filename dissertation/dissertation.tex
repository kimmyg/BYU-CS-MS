...
meaning-preservation theorem. Finally, we discuss how such a transformation would simplify
the construction of compilers which treat continuation marks correctly.
%Continuation marks do not yet enjoy a transformation to the plain $\lambda$-calculus.
}
