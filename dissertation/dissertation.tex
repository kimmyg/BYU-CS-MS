...
% ((C[(e0 e1)] C[E]) ((pair xi(E)) chi(E)))
% ((C[(e0 e1)] C[*]) ((pair false) C[nil])) ->
% ((C[e0] C[(* e1)]) ((pair false) C[nil])) ->
% ((C[e1] C[(v0 *)]) ((pair false) C[nil])) ->
% ((C[e'0[x <- v1]] C[*]) ((pair false) C[nil])
% mechanically show these steps (with C[E], xi(E), and chi(E))
% assume e0 and e1 reduce to correct values by structural induction

% ((C[(wcm e0 e1)] C[*]) ((pair false) C[nil])) ->
% ((C[e0] C[(wcm * e1)]) ((pair false) C[nil])) ->
% ((C[e1] C[*]) ((pair true) C[((pair v0) nil)])) ->

% ((C[(ccm)] C[*]) ((pair false) C[nil])) ->
% (C[*] C'[nil]) ->
% C[nil]

% ((C[v0] C[*]) ((pair false) C[nil])) ->
% (C[*] C'[v0]) ->
% C[v0] 
