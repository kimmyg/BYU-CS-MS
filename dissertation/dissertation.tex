...
\begin{proof}
Each $p\in\lambda_{cm}$ is of the form \scheme|(e_0 e_1)|, \scheme|(wcm e_0 e_1)|, \scheme|(ccm)|, \scheme{v_0}, or \scheme'x'.

Consider $((p\,\mathcal{C}[\bullet])\,((\mathbf{pair}\,\xi(\bullet))\,\mathcal{C}[\chi(\bullet)]))$. By some lemma, we have that $E[e]\rightarrow_{\lambda_{cm}} v\Rightarrow((\mathcal{C}[e]\,\mathcal{C}[E])\,((\mathbf{pair}\,\xi(E))\,\chi(E)))\rightarrow_{\lambda_v} \mathcal{C}[v]$. Then $\bullet[p]\rightarrow_{\lambda_{cm}}v\Rightarrow ((p\,\mathcal{C}[\bullet])\,((\mathbf{pair}\,\xi(\bullet))\,\mathcal{C}[\chi(\bullet)]))\rightarrow_{\lambda_v} \mathcal{C}[v]$

Note that $p=\bullet[p]$.

$p\rightarrow_{\lambda_{cm}}v\Rightarrow\mathrm{eval}_{cm}(p)=v\Rightarrow\mathcal{C}[\mathrm{eval}_{cm}(p)]=\mathcal{C}[v]$

$p\rightarrow_{\lambda_{cm}}v\Rightarrow ((\mathcal{C}[p]\,\mathcal{C}[\bullet])\,((\mathbf{pair}\,\xi(\bullet))\,\mathcal{C}[\chi(\bullet)]))\rightarrow_{\lambda_v} \mathcal{C}[v]\Rightarrow\mathrm{eval}_{v}(\mathcal{C}[p])=\mathcal{C}[v]$
