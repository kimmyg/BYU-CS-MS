...
applications from being considered as values. A value should remain independent of
...
(with (x 5)
  (with (x x)
    x))
\end{schemedisplay}
to behave as we expect (evaluating to \scheme'5').
...
%                                      {m}}}
%                           {m}}}}\\
%\Cone[\wcm{E}{F}]  &= abs{k}{\abs{m}{\app{\app{\Cone[E]}{\abs{e}{\app{\app{\Cone[F]}{k}}{\pair{e}{m}}}}{m}}}\\
%\Cone[\ccm]        &= \abs{k}{\abs{m}{\app{k}{m}}}
\end{align*}
...
Assume $E[(e_0\,e_1)]\cmrrs v$. Consider $\app{\app{\C{\app{e_0}{e_1}}}{\C{E}}}{\eval{\pair{\xi(E)}{\chi(E)}}}$.
% -> ((C[e0] C[E[(* e1)]]) ((pair xi(E[(* e1)])) C[chi(E[(* e1)])]))
Steps app1-app7 show
\[
\app{\app{\C{\app{e_0}{e_1}}{\C{E}}}\eval{\pair{\xi(E)}{\C{\chi(E)}}}}\lvrrs 
\app{\app{\C{e_0}}{\C{E[\app{\hole}{e_1}]}}}
{\eval{\pair{\xi(E[\app{\hole}{e_1}])}{\C{E[\app{\hole}{e_1}]}}}}
\]
...
\[
((\C[e_0]\,\C[E[(\hole\,e_1)]])\,\eval{\pair{\xi(E[\app{\hole}{e_1}])}{\chi(E[\app{\hole}{e_1}])}})\lvrrs (\C[E[(\hole\,e_1)]]\,\Cp[v_0])
\]
where $E[(\hole\,e_1)][e_0]\cmrrs E[(\hole\,e_1)][v_0]$, as in app8.
% -> ((C[e1] C[E[(v0 *)]]) ((pair xi(E[(v0 *)])) C[chi(E[(v0 *)])]))
By app9, 
\[
(\C[E[(\hole\,e_1)]]\,\Cp[v_0])\lvrr((\C[e_1]\,\C[E[(v_0\,\hole)]])\,\eval{\pair{\xi(E[\app{v_0}{\hole}])}{\chi(E[\app{v_0}{\hole}])}})
\]
...
Otherwise, we assume by induction that 
\[
((\C[e_1]\,\C[E[(v_0\,\hole)]])\,\eval{\pair{\xi(E[\app{v_0}{\hole}])}{\chi(E[\app{v_0}{\hole}])}})\lvrrs (\C[E[\app{v_0}{\hole}]]\,\Cp[v_1])
\]
where $E[\app{v_0}{\hole}][e_1]\cmrrs E[\app{v_0}{\hole}][v_1]$, as in app10.
% -> ((C[(v0 v1)] C[E]) ((pair xi(E)) C[chi(E)]))
By app11,
\[
(\C[E[\app{v_0}{\hole}]]\,\Cp[v_1])\lvrr(((\Cp[v_0]\,\Cp[v_1])\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})
\]
If $\Cp[v_0]=(\lambda\,(x)\,\C{e'_0})$, then, by lemma \ref{collapse},
\begin{align*}
(((\Cp[v_0]\,\Cp[v_1])\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})\lvrr &((\C[e'_0[x\leftarrow v_1]]\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})\\
% assume (v0 v1) -> e2
% -> ((C[e2] C[E]) ((pair xi(E)) C[chi(E)]))
= &((\C[e_2]\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})
\end{align*}
for some $e_2$.

% ((C[v2] C[E]) ((pair xi(E)) C[chi(E)])) is correct by assumption (structural induction (and E?))
By induction, we assume that $E[e_2]\cmrrs v\implies((\C[e_2]\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})\lvrrs \C[v]$.
...
Assume $E[\wcm{e_0}{e_1}]\cmrrs v$. Consider $((\C[\wcm{e_0}{e_1}]\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})$.
% -> ((C[e0] C[E[(wcm * e1)]]) ((pair xi(E[(wcm * e1)])) C[chi(E[(wcm * e1)])]))
Steps wcm1-wcm7 show
\[
((\C[\wcm{e_0}{e_1}]\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})\lvrrs ((\C[e_0]\,\C[E[\wcm{\hole}{e_1}]])\,\eval{\pair{\xi(E[\wcm{\hole}{e_1}])}{\chi(E[\wcm{\hole}{e_1}])}})
\]
From here, we must account for two contingencies:
\begin{enumerate}
...
Otherwise, we assume by induction that 
\[
((\C[e_0]\,\C[E[\wcm{\hole}{e_1}]])\,\eval{\pair{\xi(E[\wcm{\hole}{e_1}])}{\chi(E[\wcm{\hole}{e_1}])}})\lvrrs(\C[E[\wcm{\hole}{e_1}]]\,\Cp[v_0])
\]
where $E[\wcm{\hole}{e_1}][e_0]\cmrrs E[\wcm{\hole}{e_1}][v_0]$, as in wcm8.
By wcm9-wcm13,
\[
(\C[E[(\wcm{\hole}{e_1}]]\,\Cp[v_0])\lvrrs x
\]
...
$((\C[e_1]\,\C[E[\wcm{v_0}{\hole}]])\,\eval{\pair{\xi(E)}{\C[\chi(E)]}})\lvrrs ((\C[v_1]\,\C[E])\,\eval{\pair{\xi(E)}{\C[\chi(E)]}})$

$((\C[\wcm{v_0}{v_1}]\,\C[E])\,\eval{\pair{\xi(E)}{\C[\chi(E)]}})\lvrrs ((\C[v_1]\,\C[E])\,\eval{\pair{\xi(E)}{\C[\chi(E)]}})$
...
Assume $E[\ccm]\cmrrs v$. Consider $((\C[\ccm]\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})$.
% -> ((C[e0] C[E[(* e1)]]) ((pair xi(E[(* e1)])) C[chi(E[(* e1)])]))
Steps ccm1-ccm3 show
\[
((\C[\ccm]\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})\lvrrs ((\C[\chi(E)]\,\C[E])\,(\lambda\,(z)\,z))
\]
...
Assume $E[v]\cmrrs v'$. Consider $((\C[v]\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})$.
% by assumption of E
By assumption of the correctness of $E$, $((\C[v]\,\C[E])\,\eval{\pair{\xi(E)}{\chi(E)}})\lvrr\C[v']$.
\end{proof}
...
p\cmrrs v &\implies\hole[p]\cmrrs\hole[v] &\text{(since $p\cmrr \hole[p]$ and $v$ can only be reached by $\hole[v]$)}\\
                             &\implies((\C[p]\,\C[\hole])\,\eval{\pair{\xi(\hole)}{\C[\chi(\hole)]}})\lvrrs\C[v] &\text{(by the Great Lemma)}\\
                             &\implies((\C[p]\,(\lambda\,(v)\,\C[v]))\,\eval{\pair{\mathbf{false}}{\C[\mathbf{nil}]}})\lvrrs\C[v] &\text{(by definitions x, y, and z)}\\
...
$\mathcal{A}$ is a transformation with the property that $\mathcal{A}[(\C[e_0]\,\C[e_1])]=\C[(e_0\,e_1)]$.
