...
% if E[e] -> E[v], then C[E[e]] -> C[E[v]] by C[e] k (flag,chi(E)) -> C[v] k (flag,chi(E))
...
% E[e0'[x<-v1]] ->cm E[e3] => C[(\x.e0' v1)] k' (flag,chi(E)) ->v C[
...
% C[E[(e_0 e_1)]] k0 (false,nil) equiv C[(e_0 e_1)] k0 (flag,chi(E))
% -> C[e2] k0 (flag,chi(E))

% C[E[(ccm)]] k0 (false,nil) equiv C[(ccm)] k0 (flag,chi(E))
%by induction
...
% if E[(ccm)] -> E[chi(E)], then C[E[(ccm)]] ? ? equiv C[(ccm)] ? (flag,chi(E))
