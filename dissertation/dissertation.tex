...
v     &\text{if $((p\,\lambda v.\lambda k.\lambda m.(k\,v))\,\lambda p.((p\,\lambda x.\lambda y.y)\,C[\lambda x.\lambda y.y]))\rightarrow_{v}^{*}v$}\\
\perp &\text{if $((p\,\lambda v.\lambda k.\lambda m.(k\,v))\,\lambda p.((p\,\lambda x.\lambda y.y)\,C[\lambda x.\lambda y.y]))\rightarrow_{v}^{*}\cdots$}
\end{cases}
\]
