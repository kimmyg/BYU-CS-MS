...
% C[*] = *
% C[(* e1)] k (flag,C[vs]) = ((C[e1] \f.(((* f) k) (flag,C[vs]))) (false,C[vs]))
% C[(* e1)] = \k.\m.(\k.(k (snd m)) \s.(\k.(k (false,s)) \n.((C[e1] \f.(((* f) k) (flag,C[vs]))) n))
% C[(v0 *)] k (flag,C[vs]) = (((v0 *) k) (flag,C[vs]))
% C[(v0 *)] = \k.\m.(((v0 *) k) m)
% C[(wcm * e1)] = 
% C[(wcm v0 *)] = 
...
% show C[(wcm v0 e1)] k (flag,C[vs]) = C[e1] k (true,C[v:vs'])
...
% C[(wcm v0 (wcm v1 e2))] k (false,C[vs]) = C[(wcm v1 e2)] k (true,C[v0:vs]) = C[e2] k (true,C[v1:vs])
% C[(wcm e0 e1)] k (flag,C[vs]) -> C[(wcm * e1)] k
