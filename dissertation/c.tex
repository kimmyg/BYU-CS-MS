...
We now consider the transformation of the same program. We apply the transformation just-in-time as we reduce which has the effect of reducing term size and promoting clarity.
\begin{schemeblock}
\begin{schemedisplay}
