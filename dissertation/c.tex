...
\begin{definition}{\scheme|C[(rator-expr rand-expr)]|}
...
\begin{definition}{\scheme|C[(wcm mark-expr body-expr)]|}
...
\begin{definition}{\scheme|C[v]|=\scheme|C[(lambda (x) e)]|}
